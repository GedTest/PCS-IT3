...
print("Right now is: " + str(currentTime))
...
for i in range(0,5):
    ...
    # if day is 0 it means last day of previos month
    print("Easter sunday is on: " + str(day) + "th day in year: " + str(year +i))

"""
# 3 ukol
"""
sundayChristmass = rrule(YEARLY,dtstart=datetime.datetime.now(),bymonth=12,bymonthday=24,byweekday=SU)[0].year
print("Closest Christmas Sunday is in year: " + str(sundayChristmass))