...
def jakSeMas(arrColor, favColor):
    '''
    Tato funkce odhali moji oblibenou barvu
    '''
    for color in arrColor:
        if color == favColor:
            print(favColor + " je ma oblibena barva")
            continue

        print(color + " barva")


print(jakSeMas.__doc__)
arrColor = {'modra','cervena','zluta','zelena','fialova'}
jakSeMas(arrColor,"zluta")