...
arrVariables = [students_count, rating, is_published]
for n in arrVariables:
    print("Type of ", n, " is ", type(n), " with ID: ", id(n))
...
print("from binary 0100 to decimal: ", int('0100', base=2))
# Převod hexadecimálního čísla na desítkové
print("from hexadecimal 100 to decimal: ", int('100', base=16))
