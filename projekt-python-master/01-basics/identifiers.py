...
x = 0
# global = 1 - klíčové slova jazyku Python
Global = 1

PI = 3.14
city = "Opava"
# hilda@sspu-x.cz = 'Hilda Dokonalá' - použité neplatné znaky @ - .
hilda_sspu_x_cz = 'Hilda Dokonalá'

password2 = 'TajneHeslo'
# 007agent = 'James Bond' - proměnná nesmí začínat čísly
agent_007 = 'James Bond'
